...
public class note_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.activity_note_fragment, container, false);
        //hide view before loading data
        scrollview=(ScrollView)rootView.findViewById(R.id.scrollview_note);
        ...
        string_json=sharedPre.getString("string_json_note", "");
...
//        System.out.println("Note-string_json-main : " + string_json);
        ...
        /****choose time*******/
        imagebutton_avant=(ImageButton)rootView.findViewById(R.id.imageButton_avant);
        imagebutton_now=(ImageButton)rootView.findViewById(R.id.imageButton_now);
        imagebutton_apres=(ImageButton)rootView.findViewById(R.id.imageButton_apres);
        nomtemps=(TextView)rootView.findViewById(R.id.textView_nomtemps);
    ...
    public void getjson(){
        try {
            ...
            for(int i = 0;i<jsonArrayDomain.length();i++) {
                ...
                View view1 = getActivity().getLayoutInflater().inflate(R.layout.note_example_domain, null);
                LinearLayout linearLayout=(LinearLayout)rootView.findViewById(R.id.linearlayout1);
                LinearLayout.LayoutParams LP1=new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
                LP1.leftMargin =1 * (int) (Math.round(getActivity().getResources().getDisplayMetrics().density));
                LP1.topMargin = 5 * (int) (Math.round(getActivity().getResources().getDisplayMetrics().density));
                ...
                for(int j= 0;j<jsonArrayFacteur.length();j++) {
                    ...
                    View view2 = getActivity().getLayoutInflater().inflate(R.layout.note_example_facteur, null);
            ...
            TextView note=(TextView)rootView.findViewById(R.id.textView_note);
            note.setText(jsonRootObject.optString("moyenne").toString());
            TextView comment=(TextView)rootView.findViewById(R.id.textView_comment);
